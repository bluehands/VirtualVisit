...
public class ALPSController : MonoBehaviour {
    ...
    public void Awake(){
        ...
        head.AddComponent<PhysicsRaycaster>();

        ALPSReticle pointer = UnityEngine.Object.FindObjectOfType<ALPSReticle>();
        pointer.transform.SetParent(head.transform);
    ...
    void Update()
    {
        var ray = head.GetComponent<PhysicsRaycaster>();
