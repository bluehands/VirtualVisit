...
[AddComponentMenu("VR/UI/Pointer")]
[RequireComponent(typeof(Renderer))]
public class VRPointer : MonoBehaviour, IVRPointer {
  ...
  void OnEnable() {
    InputModule.Pointer = this;
  }

  void OnDisable() {
    if ((Object)InputModule.Pointer == this) {
      InputModule.Pointer = null;
    }
  }
