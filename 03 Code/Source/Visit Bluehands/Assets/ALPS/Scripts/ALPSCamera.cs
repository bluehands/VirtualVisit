...
public class ALPSCamera : MonoBehaviour{
    ...
    public static ALPSCamera Instance
    {
        get
        {
            if (instance == null)
            {
                instance = UnityEngine.Object.FindObjectOfType<ALPSCamera>();
            }
            if (instance == null)
            {
                Debug.LogError("No ALPSCamera instance found.");
            }
            return instance;
        }
    }

    private static ALPSCamera instance = null;
