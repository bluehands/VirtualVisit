...
public class ALPSConfig{
	...
	//Configuration name
	public CardboardType deviceName;
	...
	public ALPSConfig(CardboardType _DeviceName, bool _EnableBarrelDistortion, bool _EnableChromaticCorrection, bool _FixedSize, float _IPD, float _ILD, float _FieldOfView, float _ChromaticCorrection, float _k1, float _k2, int _Width, int _Height){
